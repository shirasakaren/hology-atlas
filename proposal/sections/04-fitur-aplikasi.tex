...
\begin{figure*}[t]
\centering
\subfloat[Papan Kanban dengan kolom Backlog, In Progress, In Review, dan Done.]{\includegraphics[width=0.485\linewidth]{assets/screenshots/curated/pmo-kanban.png}}\hfill
\subfloat[Detail tugas dibuka sebagai modal di atas papan, tanpa kehilangan konteks.]{\includegraphics[width=0.485\linewidth]{assets/screenshots/curated/pmo-task-detail.png}}\\[4pt]
\subfloat[Linimasa Gantt untuk melihat jadwal seluruh tugas sekaligus.]{\includegraphics[width=0.485\linewidth]{assets/screenshots/curated/pmo-timeline.png}}\hfill
\subfloat[Whiteboard kolaboratif real-time (Yjs CRDT) untuk pemetaan ide.]{\includegraphics[width=0.485\linewidth]{assets/screenshots/curated/pmo-whiteboard.png}}
...
\begin{figure*}[t]
\centering
\subfloat[Obrolan proyek dengan mention, reaksi, dan lampiran.]{\includegraphics[width=0.485\linewidth]{assets/screenshots/curated/chat-project.png}}\hfill
\subfloat[Ruang suara real-time dengan kontrol mikrofon dan peserta aktif.]{\includegraphics[width=0.485\linewidth]{assets/screenshots/curated/voice-room.png}}
...
\begin{figure*}[t]
\centering
\subfloat[Ringkasan status instans dan progres konfigurasi awal.]{\includegraphics[width=0.485\linewidth]{assets/screenshots/curated/godmode-overview.png}}\hfill
\subfloat[Penyedia OAuth (Google, GitHub, Discord, dan lainnya) diaktifkan tanpa deploy ulang.]{\includegraphics[width=0.485\linewidth]{assets/screenshots/curated/godmode-oauth.png}}
...
\begin{figure*}[t]
\centering
\subfloat[Atlas Blue]{\includegraphics[width=0.24\linewidth]{assets/screenshots/curated/theme-atlas.png}}\hfill
\subfloat[Sunset]{\includegraphics[width=0.24\linewidth]{assets/screenshots/curated/theme-sunset.png}}\hfill
\subfloat[Mint]{\includegraphics[width=0.24\linewidth]{assets/screenshots/curated/theme-mint.png}}\hfill
\subfloat[Lavender]{\includegraphics[width=0.24\linewidth]{assets/screenshots/curated/theme-lavender.png}}\\[4pt]
\subfloat[Deep Ocean]{\includegraphics[width=0.24\linewidth]{assets/screenshots/curated/theme-ocean.png}}\hfill
\subfloat[Rose]{\includegraphics[width=0.24\linewidth]{assets/screenshots/curated/theme-rose.png}}\hfill
\subfloat[Midnight (gelap)]{\includegraphics[width=0.24\linewidth]{assets/screenshots/curated/theme-midnight.png}}\hfill
\subfloat[Noir (gelap)]{\includegraphics[width=0.24\linewidth]{assets/screenshots/curated/theme-noir.png}}
